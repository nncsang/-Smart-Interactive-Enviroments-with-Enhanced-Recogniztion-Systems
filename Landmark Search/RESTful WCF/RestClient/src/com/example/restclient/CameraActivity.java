...
public class CameraActivity extends FragmentActivity implements CameraListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCameraFragment = (CameraFragment)getSupportFragmentManager().findFragmentById(R.id.cameraFragment);
    }
    ...
    public void onBackPressed() {
        ...
        if (mIsDetail == true){
            ...
            mCameraFragment.deleteOldPhoto();
            super.onBackPressed();
        }
    }
