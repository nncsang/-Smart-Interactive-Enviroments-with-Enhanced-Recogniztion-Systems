...
public class AnimationFactory {
        ...
        public static void flipTransition(final ViewAnimator viewAnimator, FlipDirection dir, int nextIndex) {

            final View fromView = viewAnimator.getCurrentView();
            final int currentIndex = viewAnimator.getDisplayedChild();
            viewAnimator.setDisplayedChild(nextIndex);
            //final View toView = viewAnimator.getChildAt(viewAnimator.getDisplayedChild());

            Animation[] animc = AnimationFactory.flipAnimation(fromView, null, dir, 500, null);
